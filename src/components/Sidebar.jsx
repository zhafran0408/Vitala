      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-20 items-center justify-between border-b px-5">
            ...
            >
              <div className="flex size-10 items-center justify-center rounded-full bg-foreground text-background transition-transform duration-500 group-hover:rotate-12">
            ...
            <div className="space-y-1.5">
              {menus.map((menu, index) => {
                ...
                return (
                  ...
                  >
                    <span
                      className={`flex size-9 shrink-0 items-center justify-center rounded-lg transition-transform duration-300 ${
